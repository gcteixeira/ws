...
public class GeraPedido {
	...
	public void criaPedido(WebDriver driver) throws InterruptedException {
		this.driver = driver;
		...
		WebElement btnPesquisaParceiro = fluentWait(
				By.xpath("//*[@id='formPedido']/div[1]/ul/li[3]/div/div/div/a[1]/img"));
		...
		WebElement pPesquisasSelecinarCliente = fluentWait(
				By.xpath("/html/body/div[7]/div[2]/div[2]/div[4]/div/div/div[1]"));
		...
		WebElement pesquisasSelecinarProduto = driver
				.findElement(By.xpath("//*[@id='produtos']/div/div[4]/div/div/div[1]"));
		...
		WebElement pesquisasSelecinarProdutoDaGrid = fluentWait(
				By.xpath("//*[@id='produtos']/div/div[4]/div/div/div[1]/a/span"));
		...
		WebElement gripquantidadepedido2 = fluentWait(
				By.xpath("//*[@id='produtos']/div/div[4]/div/div[2]/div[3]/input"));
		...
		WebElement gridNumeroPedidoCliente1 = fluentWait(
				By.xpath("//*[@id='produtos']/div/div[4]/div/div[2]/div[9]/input"));
		Thread.sleep(2000);
		...
		// WebElement localEntrega =
		// fluentWait(By.xpath("//*[@id='entregaPanel']/div/div[4]/div/div/div[2]"));
		// localEntrega.click();
